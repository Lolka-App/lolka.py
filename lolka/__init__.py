...
A wrapper for the lolka bot API — a fork of discord.py that talks to lolka by
default (REST/Gateway) and connects to lolka voice (WebRTC) instead of Discord.

:copyright: (c) 2015-present Rapptz (discord.py), lolka fork
